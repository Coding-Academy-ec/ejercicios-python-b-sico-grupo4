...
def imprimir_nombre():
    print("Grupo 4")  # Aquí se imprime el nombre en la pantalla
...
if __name__ == "__main__":
    ...
    print("La suma es:", resultado)  # Se imprime el resultado de la suma
...
def imprimir_datos_personales(nombre, edad, estatura):
    print("Nombre: "+ nombre+ "\nEdad: "+ str(edad)+ "\nEstatura: "+ str(estatura))  # Se imprimen en pantalla los datos personales recibidos como argumentos
...
if __name__ == "__main__":
    ...
    print("El área es:", area_circulo(radio))  # Se imprime el area_circulo(radio)  # Se imprime el área calculada del círculo
